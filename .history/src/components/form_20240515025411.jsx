        ...
        >
          <li className="w-full border-b border-gray-500 rounded-t-lg dark:border-gray-600">
            <div className="flex items-center ps-3">
              ...
              <button
                type="button"
                className="ms-auto -mx-1.5 -my-1.5  text-[transparent] font-bold hover:text-gray-900  p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-7 w-7 "
              >
