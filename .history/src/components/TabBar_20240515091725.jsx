    ...
    <>
      ...
      >
        <li className="me-2" role="presentation">
          <button
            className="inline-block hover:text-gray-600 hover:border-gray-300"
        ...
        <li className="me-2" role="presentation">
          <button
            className="inline-block   hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
