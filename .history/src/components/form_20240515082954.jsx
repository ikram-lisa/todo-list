            ...
            >
              <div className="flex items-center justify-between ps-3">
                <label className="custom-checkbox flex items-center gap-3 w-full py-3 ms-2 text-sm font-medium">
                  <input
                    type="checkbox"
                    checked={todo.isCompleted} // make sure to use the correct property name
                    onChange={() => handleToggleCompleted(todo.id)} // you might need to implement this function
                    className="mr-5 mt-2"
                  />
                  <div className="checkbox-custom"></div>
                  {todo.text}{" "}
                  {/* Moved inside label for proper text display next to the checkbox */}
                </label>
                <button
                  type="button"
